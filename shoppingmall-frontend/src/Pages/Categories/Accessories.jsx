  ...
  const getAllProducts = async () => {
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:8080/product/allproducts/accessories`,
  ...
  return (
    <Layout title={"ShoppingMall- Shop Now"}>
      ...
      <div className="col-md-12 order-md-2 order-1 pt-2">
        <h1 className="text-center">Accessories Category</h1>
        <hr />
        ...
        <div className="d-flex flex-wrap justify-content-center">
          {products?.map((p) => {
            return (
              <>
                <div className="card m-4" style={{ width: "16rem", height: "25rem" }}>
                  <img
